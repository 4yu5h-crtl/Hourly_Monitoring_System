...
CREATE TABLE IF NOT EXISTS loss_details (
  ...
  ct_loss_reason TEXT,
  start_loss INT,
  start_loss_reason TEXT,
  mech_maintenance INT,
  mech_maintenance_reason TEXT,
  elect_maintenance INT,
  elect_maintenance_reason TEXT,
  reset INT,
  reset_reason TEXT,
  machine_adjustment INT,
  machine_adjustment_reason TEXT,
  supplier INT,
  supplier_reason TEXT,
  shared_operation INT,
  shared_operation_reason TEXT,
  tool INT,
  tool_reason TEXT,
  spindle_service INT,
  spindle_service_reason TEXT,
  wheel_change INT,
  wheel_change_reason TEXT,
  operator INT,
  operator_reason TEXT,
  plan_stop INT,
  plan_stop_reason TEXT,
  quality INT,
  quality_reason TEXT,
  system_loss INT,
  system_reason TEXT,
